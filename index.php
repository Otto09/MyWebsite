...
.bgimg-1 {
    background-image: url('kutya.jpg');
    min-height: 690px;
}
...
<div class="bgimg-1 w3-display-container" id="home">
	...
	w3-opacity-min">My <span class="w3-hide-small">Web</span>site</span>
	</div>
</div>
...
<div class="w3-content w3-container new-padding" id="about">
  ...
  <p class="w3-center"><em>I love to run much</em></p>
  <p>This is a fictional "personal" website/blog, and this fictional character is a dog.</p>
  <div class="w3-row">
    <div class="w3-col m6 w3-center w3-padding-large">
      <p><b><i class="fa fa-user w3-margin-right"></i>Doggy</b></p><br>
      <img src="kutya.jpg" class="w3-round w3-image w3-opacity w3-hover-opacity-off"
	  alt="Photo of Me" width="500" height="333">
    </div>

    <!-- Hide this text on small devices -->
    <div class="w3-col m6 w3-hide-small w3-padding-large">
      <p>Welcome to my website! Welcome to my website! Welcome to my website! 
      ...
      Welcome to my website! Welcome to my website! Welcome to my website! 
      Welcome to my website! Welcome to my website! Welcome to my website! 
      Welcome to my website! Welcome to my website! </p>
    </div>
  </div>
</div>
...
<div class="w3-content w3-container w3-padding-64">
  ...
  <p class="w3-center"><em>Here are some examples.<br> Click on the boxes to open them. </em></p><br>
</div>
